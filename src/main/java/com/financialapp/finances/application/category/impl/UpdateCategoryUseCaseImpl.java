...
import com.financialapp.finances.domain.usecase.category.UpdateCategory;
...
public class UpdateCategoryUseCaseImpl implements UpdateCategory {
    ...
    public Category execute(UpdateCategoryCommand command) {
        ...
        return categoryRepository.save(category.rename(command.newName()));
    }
}
